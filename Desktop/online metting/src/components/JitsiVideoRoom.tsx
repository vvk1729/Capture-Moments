...
export default function JitsiVideoRoom({ roomId, userName, onLeave }: JitsiVideoRoomProps) {
  ...
  const [maxVisibleParticipants, setMaxVisibleParticipants] = useState(25)
      ...
      try {
        ...
        const options = {
          ...
          configOverwrite: {
            ...
            channelLastN: 25, // Show last 25 active speakers
